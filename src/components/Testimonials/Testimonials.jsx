export default function Testimonials() {
  return (
    <>
      <article id="testimonials" className="flex flex-col items-center mt-28">
        ...
        <div className="flex flex-wrap lg:flex-nowrap justify-center w-11/12 lg:w-9/12 mt-10 lg:mt-16 gap-8">
          <div className="bg-zinc-100 p-10 shadow-lg">
            ...
            <div className="flex flex-wrap gap-6 mt-8">
              <i className="fa-solid fa-user text-7xl text-blue-600"></i>
              <div className="flex flex-col justify-center">
                <h1 className="text-lg font-bold">Leonardo Mello</h1>
                <h2>Palhoça, SC</h2>
              </div>
              <div className="flex items-center ml-auto">
                <i className="fa-solid fa-percent text-6xl text-blue-600"></i>
              </div>
            </div>
          </div>
          <div className="bg-zinc-100 p-10 shadow-lg">
